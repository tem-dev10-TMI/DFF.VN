        ...
        <div class="content-left cover-page">
            <div class="block-k box-company-label">
                <h5>
                    ...
                    <span class="c-note"><i class="fas fa-tag"></i> Vĩ mô</span>
                </h5>
                <div class="box-company">
                    <div class="item">
                        <ul>
                            <li>
                                <img class="logo" alt="Vĩ mô" src="https://via.placeholder.com/80x80/4A90E2/FFFFFF?text=🌍">
                            </li>
                            ...
                            <li class="f-folw">
                                <a data-type="5" href="javascript:void(0)" data-ref="topic-macro">
                                    <val>Theo dõi</val>
