    ...
    <div class="about-content">
      <article class="about-body dcontent">
        ...
        <section id="gioithieu">
          <h2>VỀ CHÚNG TÔI</h2>
          <p>Mạng xã hội Kinh tế - Tài chính DFF (DFF.VN) là mạng xã hội chính thống, hoạt động theo Giấy
            phép số 125/GP-BTTTT cấp ngày 11 tháng 03 năm 2022 bởi Bộ trưởng Bộ Thông tin và
            Truyền thông.</p>
          <p>Định vị là mạng xã hội kinh tế tài chính chuyên biệt cho nhà đầu tư, cộng đồng tài
            chính và các thành phần thị trường, DFF.VN phát triển đa kênh, đa nền tảng, là một
            tổ hợp truyền thông tương tác theo hướng chuyên sâu, chuyên biệt.</p>
          <p>DFF.VN đã và đang thu hút lượng lớn người dùng có kiến thức kinh tế, có năng lực tài
            chính, có nhu cầu đầu tư; cùng cộng đồng đông đảo người theo dõi có nhu cầu thông
            tin, có sức mua, có ảnh hưởng và khả năng lan tỏa.</p>
          <p>Không ngừng hoàn thiện và phát triển, DFF.VN hướng đến vị thế diễn đàn thông tin kinh
            tế tài chính chuyên biệt và uy tín hàng đầu thị trường.</p>
          <h3>Tổ chức thiết lập:<br> CTCP Tài chính số</h3>
          <p>Địa chỉ: Tầng 6, Tòa nhà Ladeco, 266 Đội Cấn, Phường Cống Vị, Quận Ba Đình, Thành phố Hà Nội, Việt
            Nam</p>
        ...
        <section id="dinhnghia">
          ...
          <h3>I. Điều khoản định nghĩa</h3>
            ...
            <li>Nhà cung cấp dịch vụ mạng xã hội (sau đây gọi là “Nhà cung cấp” hoặc “Chúng tôi”) là Công ty Cổ
                phần Tài chính số, được thành lập và hoạt động hợp pháp theo quy định của pháp luật Việt Nam.</li>
            <li>Người sử dụng dịch vụ mạng xã hội (sau đây gọi là “Người sử dụng” hoặc “Bạn”) là cá nhân sở hữu
                ...
                Bài viết của người sử dụng được hoặc không được phép đăng tải dựa trên đánh giá của Bộ phận kiểm
                duyệt nội dung, phù hợp với phạm vi thông tin trao đổi và quy định pháp luật.</li>
            <li>Thông tin cá nhân là thông tin gắn với việc xác định danh tính của người sử dụng, do người sử
                dụng cung cấp để tạo tài khoản đăng nhập hệ thống mạng xã hội của nhà cung cấp.</li>
            <li>Thông tin riêng là thông tin mà người sử dụng cung cấp trên mạng xã hội dưới hình thức không
                công khai hoặc chỉ công khai cho một hoặc một nhóm người sử dụng đã được xác định cụ thể.</li>
            <li>Thông tin công cộng là thông tin trên mạng xã hội do nhà cung cấp hoặc người sử dụng công khai
                cho tất cả những người sử dụng khác mà không cần xác định thông tin cá nhân cụ thể.</li>
            <li>Ban quản trị mạng xã hội là bộ phận trực thuộc nhà cung cấp, chịu trách nhiệm quản lý hoạt động
                của trang mạng xã hội; giải quyết các trường hợp vi phạm, khiếu nại của người sử dụng và các vấn
                đề liên quan trong quá trình quản lý hoạt động.</li>
            <li>Bộ phận kiểm duyệt nội dung là bộ phận trực thuộc nhà cung cấp, chịu trách nhiệm kiểm tra, phê
                duyệt nội dung bài viết, thông tin do người sử dụng cung cấp để đăng tải; đồng thời hỗ trợ Ban
                quản trị mạng xã hội phát hiện và xử lý vi phạm.</li>
            </ol>

            <p>Khi sử dụng bất cứ sản phẩm hay dịch vụ nào của nhà cung cấp, hoặc khi đăng ký thành viên, bạn xác
            nhận đã đọc, hiểu và đồng ý với tất cả các Điều khoản được đề cập ở đây.</p>
            <p>Nếu có bất kỳ điểm nào bạn không đồng ý, xin vui lòng dừng sử dụng các sản phẩm và dịch vụ của nhà
            cung cấp.</p>
            <p>Mọi thắc mắc vui lòng liên hệ email: <a href="mailto:info@dff.vn">info@dff.vn</a></p>
        ...
        <section id="quydinh">
          ...
          <ol>
            <li>- Nội dung chống lại Nhà nước Cộng hòa Xã hội Chủ nghĩa Việt Nam, gây phương hại đến an ninh quốc
            ...
            <li>- Nội dung liên quan đến bí mật nhà nước, bí mật quân sự, an ninh, kinh tế, đối ngoại và những bí
            ...
            <li>- Nội dung quảng cáo, tuyên truyền, mua bán hàng hóa, dịch vụ bị cấm, truyền bá tác phẩm báo chí,
            ...
            <li>- Nội dung miêu tả tỉ mỉ những hành động dâm ô, bạo lực, giết người rùng rợn; các hình ảnh phản cảm, thiếu tính nhân văn, không phù hợp 
              với thuần phong, mỹ tục Việt Nam.</li>
            <li>- Nội dung tuyên truyền những thông điệp mang tính quảng cáo, mời gọi, quảng bá cơ hội đầu tư hay
        ...
        <section id="xulyvipham">
          ...
          <p>Khi ban quản trị mạng xã hội phát hiện hoặc nhận được phản ánh về việc Người sử dụng vi phạm quy
            định, chúng tôi có quyền:</p>
          <p>Dựa theo sự xem xét, cân nhắc của ban quản trị mạng xã hội về mức độ thiệt hại do hành vi vi phạm
            của người sử dụng gây ra, ban quản trị mạng xã hội sẽ quyết định hình thức xử lý vi phạm tương ứng:</p>
          <li>- Nhắc nhở, cảnh cáo: Đối với hành vi vi phạm quy định của mạng xã hội DFF.VN về thể thức, vị trí;
            nội dung rác, nội dung quảng cáo, nội dung ảnh hưởng đến uy tín của cá nhân, tổ chức khác có hành vi
            xâm phạm quyền và lợi ích của mạng xã hội DFF.VN ban quản trị có quyền xóa, chuyển chuyên mục,
            lọc bỏ nội dung quảng cáo, thay từ ngữ không phù hợp, tạm ngừng hiển thị chờ kiểm duyệt tùy theo mức
            độ vi phạm. Đồng thời, thành viên đó sẽ bị nhắc nhở, cảnh cáo (vi phạm lần đầu) hoặc bị áp dụng hình
            thức khóa tài khoản tạm thời (07) ngày hoặc khóa tài khoản vĩnh viễn (vi phạm lần thứ ba).</li>
          <li>- Khóa tài khoản: Đối với hành vi vi phạm quy định pháp luật về nội dung cấm đăng tải, chia sẻ,
            trao đổi trên mạng xã hội: ban quản trị mạng xã hội DFF.VN có quyền khóa, xóa ngay lập tức bài đăng mà
            không cần thông báo. Đồng thời, thành viên đó sẽ bị nhắc nhở, cảnh cáo (vi phạm lần đầu) hoặc khóa
            tài khoản vĩnh viễn (vi phạm lần thứ hai hoặc lần thứ ba).</li>
          <li>- Ngay khi tự phát hiện hoặc có yêu cầu từ phía cơ quan Nhà nước có thẩm quyền (bằng văn bản, điện
            thoại, email), nội dung vi phạm sẽ bị loại bỏ trong thời gian tối đa 03 (ba) giờ.</p>
          <p>Lưu ý: Trường hợp người sử dụng thực hiện hành vi vi phạm pháp luật, vi phạm quy định tại Thỏa thuận
            ...
            khác có liên quan, ban quản trị mạng xã hội sẽ quyết định xóa và chặn tài khoản mạng xã hội của
            người sử dụng ngay lập tức kể từ lần đầu phát hiện vi phạm; đồng thời đưa vụ việc ra cơ quan quản lý
            nhà nước để xử lý theo quy định của pháp luật nước Cộng hòa Xã hội Chủ nghĩa Việt Nam.</p>
        </section>
        ...
        <section id="canhbao">
          ...
          <ol>
            ...
            <li>Người sử dụng phải đảm bảo các nội dung được đăng tải lên mạng xã hội đều không vi phạm luật sở
              hữu trí tuệ của Việt Nam và quốc tế. Sử dụng dịch vụ của mạng xã hội không có nghĩa là người sử
        ...
        <section id="matkhau">
          ...
          <p>Bằng việc đăng ký tài khoản trên trang web của Chúng tôi, bạn xác nhận đã hiểu và đồng ý rằng tài
            ...
            được phép sử dụng.</p>
          <p>Bạn có trách nhiệm phải tự bảo mật tài khoản và mật khẩu của mình, đảm bảo cho chính cá nhân mình
            sử dụng, cũng như chịu trách nhiệm hoàn toàn về các hoạt động liên quan đến tài khoản của bạn.</p>
          ...
          <p>Bạn đồng ý thông báo ngay cho chúng tôi qua hệ thống hỗ trợ info@dff.vn khi phát hiện có bất cứ ai sử
          ...
          <p>Trong bất kỳ trường hợp nào, chúng tôi cũng sẽ không chịu trách nhiệm cho bất cứ vấn đề hay thiệt hại
            ...
            ngoài tầm kiểm soát của chúng tôi, hay do bạn làm mất thông tin tài khoản của mình.</p>
        ...
        <section id="mientru">
          ...
          <p>Chúng tôi luôn đảm bảo bạn có thể truy cập trang web, sản phẩm và dịch vụ không bị gián đoạn, nhưng
            không có ràng buộc pháp lý nào đối với việc này.</p>
          ...
          <p>Quyền miễn trừ trách nhiệm quy định trong điều khoản này áp dụng cho tất cả mọi thiệt hại hay tổn
            ...
            nạn, thảm hoạ, mất quyền truy cập hoặc kiểm soát, hoặc trong bất kỳ tình huống bất khả kháng nào.</p>
          ...
          <p>- Không thể truy cập được trang web, các sản phẩm và dịch vụ, hoặc các ứng dụng nhúng của bên thứ
            ...
            ra trong quá trình hệ thống bị gián đoạn<br>- Gián đoạn do các nhà cung cấp, bao gồm không giới hạn
          ...
          <p>Bạn cũng đồng ý rằng chúng tôi sẽ không chịu trách nhiệm đối với các hành vi gây tổn thất, thiệt hại,
            ...
            Mọi thiệt hại hay tổn thất – nếu có – sẽ được quy kết trách nhiệm cho cá nhân hoặc tổ chức gây ra.</p>
          <p>Bạn cũng đồng ý rằng phạm vi trách nhiệm và đền bù, nếu có, của chúng tôi và các đối tác, người sử
            dụng, nhân viên, cộng tác viên, hay bất kỳ cá nhân hoặc tổ chức nào khác có liên quan (dù có hay
            không có hợp đồng hay thoả thuận), liên quan đến các sản phẩm và dịch vụ, nội dung hay tài liệu, sẽ
            không vượt quá mức phí mà bạn đã trả cho chúng tôi cho loại sản phẩm hay dịch vụ mà bạn sử dụng.</p>
        </section>
        ...
        <section id="thaydoi">
          ...
          <p>Chúng tôi có quyền chỉnh sửa, bổ sung các điều khoản sử dụng này mà không cần báo trước cho bạn. Tuy
            ...
            nhận biết được những thay đổi, chỉnh sửa, bổ sung.</p>
          <p>Bạn xác nhận và đồng ý rằng bạn có trách nhiệm ghé thăm trang này thường xuyên để kiểm tra và cập
            ...
            dịch vụ của trang web, tham gia nội dung khóa học và tài liệu, sau khi có những thay đổi trong điều
        ...
        <section id="thuthap">
          ...
          <ol>
            ...
            <li>Thông tin được thu thập trên mạng xã hội sẽ được sử dụng rộng khắp trên toàn bộ dịch vụ mạng xã
              ...
              mục đích trên mạng xã hội, để đảm bảo tối ưu hoá tính năng và hiệu quả của thông tin được sử
              dụng.</li>
            <li>Nhà cung cấp sẽ lưu trữ các thông tin cá nhân do người sử dụng đăng tải trên các hệ thống nội bộ
              của nhà cung cấp trong quá trình cung cấp dịch vụ cho người sử dụng hoặc cho đến khi hoàn thành
            ...
            <li>Nhà cung cấp không tiết lộ, chia sẻ, cho thuê, hoặc bán những thông tin cá nhân, thông tin riêng
              ...
              đồng ý hoặc nhà cung cấp nhận được yêu cầu cung cấp thông tin từ các cơ quan nhà nước có thẩm
              quyền.</li>
          </ol>
        </section>
        ...
        <section id="baomat">
          ...
          <ol>
            <li>Nhà cung cấp nỗ lực tối đa bảo mật các thông tin cá nhân, thông tin riêng của người sử dụng
              ...
              nào đối với bất kỳ khiếu nại, tranh chấp hoặc thiệt hại nào phát sinh từ hoặc liên quan đến việc
            ...
            <li>Nhà cung cấp thực hiện biện pháp bảo mật thông tin cá nhân của người sử dụng bằng cách:
              ...
              <br>- Xoá thông tin cá nhân của người sử dụng khi thông tin không còn cần thiết cho mục đích lưu trữ
            ...
            <li>Nếu người sử dụng cho rằng bảo mật của mình bị xâm phạm hay xâm nhập do tình trạng không được
              ...
              ban quản trị mạng xã hội để phản ánh và được giải quyết vấn đề.</li>
        ...
        <section id="quyenriengtu">
          ...
          <ol>
            <li>Người sử dụng có quyền giữ bí mật và quyền quyết định tiết lộ thông tin của mình bao gồm thông
              tin cá nhân, thông tin riêng và các thông tin có liên quan khác được cung cấp, trao đổi trên
              ...
              yêu cầu của cơ quan nhà nước có thẩm quyền.</li>
            <li>Chỉ người sử dụng có quyền truy cập (bao gồm tạo, xem, chỉnh sửa, xóa) và kiểm soát thông tin cá
              nhân, thông tin riêng và các thông tin có liên quan khác mà người sử dụng cung cấp, chia sẻ,
            ...
            <li>Trường hợp người sử dụng đăng ký sử dụng dịch vụ của bên thứ ba trên mạng xã hội, người sử dụng
              đồng ý cung cấp thông tin cá nhân, thông tin riêng và các thông tin có liên quan khác cho bên
