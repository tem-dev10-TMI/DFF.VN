...
<main class="main-content">
  ...
  <div class="trends-container">
    <div class="input-group">
      <input id="trendSearch" class="form-control" type="search" placeholder="Tìm kiếm xu hướng"
            ...
            <ul>
              ...
              <?php if (!empty($list)): ?>
                <?php foreach ($list as $a): ?>
                  <li>
                    <a
                      href="<?= BASE_URL ?>/details_blog/<?= $a['slug'] ?>"><?= htmlspecialchars($a['title']) ?></a>
                    <span class="date"><i class="far fa-calendar-alt"></i>
                      <?= htmlspecialchars(date('d/m/Y H:i', strtotime($a['created_at'] ?? 'now'))) ?></span>
                    <span class="name"><i class="far fa-user"></i>
                      <?= htmlspecialchars($a['author_name'] ?? '') ?></span>
                  </li>
                <?php endforeach; ?>
              <?php else: ?>
