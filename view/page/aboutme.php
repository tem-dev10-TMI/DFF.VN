    ...
    <div class="container">
        ...
        <aside class="sidebar">
            ...
            <ul>
                ...
                <li><a href="#puydinh">puy định phạm vi nội dung trao đổi, chia sẻ trên mạng xã hội DFF</a></li>
                <li><a href="#xulyvipham">Cơ chế xử lý vi phạm</a></li>
                <li><a href="#canhbao">Cảnh báo về các rủi ro khi lưu trữ, trao đổi và chia sẻ thông tin</a></li>
                <li><a href="#matkhau">Tài khoản và mật khẩu</a></li>
                <li><a href="#mientru">puyền miễn trừ trách nhiệm</a></li>
                <li><a href="#thaydoi">puyền thay đổi Điều khoản Sử dụng</a></li>
            </ul>

            <h3>Chính sách riêng tư</h3>
            <ul>
                <li><a href="#thuthap">Chính sách thu thập, xử lý các thông tin cá nhân của người sử dụng dịch vụ mạng
                        xã hội</a></li>
                <li><a href="#baomat">Chính sách bảo mật thông tin của người sử dụng dịch vụ mạng xã hội</a></li>
                <li><a href="#puyenriengtu">Chính sách puyền riêng tư</a></li>
            </ul>
        </aside>
        ...
        <main class="content">
            ...
            <section id="gioithieu">
                ...
                <h4>Tổ chức thiết lập: <br> CTCP Tài chính số</h4>
            ...
            <!-- puy định phạm vi -->
            <section id="puydinh">
                <h4>II. puy định phạm vi nội dung trao đổi, chia sẻ trên mạng xã hội DFF</h4>
            ...
            <section id="xulyvipham">
                <h4>III. Cơ chế xử lý vi phạm</h4>
            ...
            <!-- Cảnh báo -->
            <section id="canhbao">
                <h4>IV. Cảnh báo về các rủi ro khi lưu trữ, trao đổi và chia sẻ thông tin trên mạng xã hội</h4>
                <ol>
            ...
            <!-- Miễn trừ -->
            <section id="mientru">
                <h4> puyền miễn trừ trách nhiệm</h4>
            ...
            <!-- Thay đổi -->
            <section id="thaydoi">
                <h4>puyền thay đổi Điều khoản Sử dụng</h4>
            ...
            <section id="thuthap">
                <h3>Chính sách riêng tư</h3>
                <h4>I. Chính sách thu thập, xử lý các thông tin cá nhân của người sử dụng dịch vụ mạng xã hội</h4>
                <ol>
                    <li></li> Nhà cung cấp đảm bảo rằng mọi thông tin cá nhân thu thập được trên website mạng xã hội là
                    dựa trên cơ sở đăng nhập và khai báo của người sử dụng.</li>
            ...
            <section id="baomat">
                <h4>II. Chính sách bảo mật thông tin của người sử dụng dịch vụ mạng xã hội</h4>
                <ol>
            ...
            <section id="puyenriengtu">
                <h4>III. Chính sách puyền riêng tư</h4>
                <ol>
