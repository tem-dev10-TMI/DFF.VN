...
<head>
    ...
    <title>404 - Lạc Lối Giữa Thiên Nhiên</title>
    ...
    <style>
        ...
        @keyframes day-night-cycle {
            0% { background: linear-gradient(to bottom, #2c3e50, #4ca1af); } /* Đêm -> Sáng */
            25% { background: linear-gradient(to bottom, #87CEEB, #B0E0E6); } /* Sáng */
            50% { background: linear-gradient(to bottom, #ff7e5f, #feb47b); } /* Chiều */
            75% { background: linear-gradient(to bottom, #485563, #29323c); } /* Tối */
            100% { background: linear-gradient(to bottom, #2c3e50, #4ca1af); } /* Đêm */
        }
        ...
        #sun { background: radial-gradient(circle, rgba(255,253,208,1) 0%, rgba(255,253,208,0) 70%); }
        #moon { background: radial-gradient(circle, rgba(240,240,255,1) 0%, rgba(240,240,255,0) 70%); transform: rotate(180deg); }
        ...
        #fireflies-container {
            position: absolute;
            inset: 0;
            z-index: 5; /* Lowered to be behind the text content */
        }
    ...
    <div class="scene" id="scene">
        ...
        <div class="absolute inset-0 flex flex-col items-center justify-center text-center z-10 text-white p-4">
            <div class="text-container" style="text-shadow: 2px 2px 8px rgba(0,0,0,0.6);">
                ...
                <a href="home" class="mt-8 inline-block bg-white text-blue-800 font-bold py-3 px-8 rounded-full text-lg shadow-xl transform hover:scale-105 transition-transform duration-300 hover:shadow-2xl z-5">
                    Trở Về Nhà
                </a>
            </div>
        </div>
