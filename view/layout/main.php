...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="floating-social">
            <a href="crypton" title="Coin">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="coin-icon">
                    <path
            ...
            <a href="https://www.youtube.com/@DzKhanh-g8j" target="_blank" title="Youtube">
                <i class="fa-brands fa-youtube" style="color: #e40707;"></i>
                <a href="https://www.instagram.com/mang.xahoi?igsh=NmJ6eWJ2aWszb2x4&utm_source=qr" target="_blank"
                    title="Instagram">
                    <i class="fab fa-instagram" style="color:#B197FC;"></i>
                </a>
                <a href="#top" title="Lên đầu trang">
                    <i class="fa-solid fa-arrow-up-from-bracket" style="color: #0b0b0bff;"></i>
                </a>
        </div>
