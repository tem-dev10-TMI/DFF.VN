...
<nav class="sidebar-mobile">
    <ul class="menu">
        ...
        <li><a href="/topic/vi-mo"><img class="topic-thumb" src="public/img/topic-vimo.svg" alt=""> <span>Vĩ
                    mô</span></a></li>
        <li><a href="/topic/thi-truong"><img class="topic-thumb" src="public/img/topic-thitruong.svg" alt=""> <span>Thị
                    trường</span></a></li>
        ...
        <li><a href="/policy-content"><i class="fas fa-file-contract icon"></i> <span>Chính sách nội dung</span></a>
        </li>
